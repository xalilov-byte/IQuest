...
(function (root) {
  ...
  const TABLE = [
    ...
    { id: 'fixer-20', coins: 20, tier: 'silver', target: 20, value: (s, c) => Math.max(num(s.fixes), num(c.fixes)),
      ...
      cond: L('Xatolarimdan jami 20 ta savolni tuzating', 'Исправьте 20 вопросов из «Ошибок»', 'Fix 20 questions from Mistakes') },
    ...
    { id: 'spatial-7', coins: 30, tier: 'silver', target: 7, value: s => num(obj(s.levels).spatial),
      name: L('Fazo ustasi', 'Мастер фигур', 'Space master'),
    ...
    { id: 'verbal-7', coins: 30, tier: 'silver', target: 7, value: s => num(obj(s.levels).verbal),
      ...
      cond: L('Ogʻzaki mantiqda 7-darajaga yeting', 'Достигните 7-го уровня в словесной логике', 'Reach level 7 in Verbal reasoning') },
